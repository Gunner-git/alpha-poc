...
export function Avatar(props) {
  ...
  const audio1 = useMemo(() => new Audio(`/audios/line1.mp3`), [script]);
  const audio2 = useMemo(() => new Audio(`/audios/line2.mp3`), [script]);
  ...
  const startAudio = document.querySelector("button.startButton2");

  startAudio.addEventListener("click", () => {
    audio1.play();
  });

  const nextScreen = document.querySelector("button.nextScreenButton");
